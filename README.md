...
- [Historical Figure Simulators](https://ordinarymantrying.com/tools/simulators.html) - Chat with 100+ AI simulations of historical figures: Buffett, Darwin, Einstein, Curie, Marcus Aurelius, Shakespeare, and more. Each adopts the figure's documented worldview and writing style. Open source. ([GitHub](https://github.com/daligao/historical-figure-simulators))
